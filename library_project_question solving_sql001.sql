...
-- Task 6: Create Summary Tables: Used CTAS to generate new tables based on query results - each book and total book_issued
...
-- ask 8: Find Total Rental Income by Category:
...
BEGIN
    ...
    ELSE
        RAISE NOTICE 'Sorry, the book you requested is unavailable. Book ISBN: %', p_issued_book_isbn;
    END IF;
END;
$$;  -- ✅ this semicolon was missing

-- ✅ Testing section (these are outside the procedure)
SELECT * FROM books;
